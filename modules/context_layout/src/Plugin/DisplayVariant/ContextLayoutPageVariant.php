 ...
 *   admin_label = @Translation("Page with blocks and layout integration")
 * )
 */
class ContextLayoutPageVariant extends VariantBase implements PageVariantInterface, ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new ContextLayoutPageVariant.
   *
  ...
  public function build() {
    $build = [
      '#cache' => [
        'tags' => ['context_layout_page', $this->getPluginId()],
      ],
    ];
    ...
    foreach ($this->contextManager->getActiveReactions('layouts') as $reaction) {
